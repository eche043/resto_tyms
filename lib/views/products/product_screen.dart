...
class _ProductScreenState extends State<ProductScreen> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            top: kToolbarHeight + MediaQuery.of(context).padding.top + 150.0,
            left: 0,
            right: 0,
            bottom: 0,
  ...
  Widget buildTab(String label, int index, ProductsProvider productProvider) {
  ...
  Widget _buildContent(ProductsProvider productProvider) {
    ...
    List<FoodsData> product = currentTab == 0
        ? productProvider.productData
        : productProvider.getFilteredProducts(currentTab);
