...
class MyAppThemes {
  static final lightTheme = ThemeData.light().copyWith(
    ...
    appBarTheme:
        AppBarTheme(backgroundColor: MyAppColors.primaryBackgroundColor),

    inputDecorationTheme: InputDecorationTheme(
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(15.0),
        borderSide:
            BorderSide(color: MyAppColors.secondaryTextColor, width: 2.0),
      ),
    ...
    bottomAppBarTheme:
        BottomAppBarTheme(color: MyAppColors.darkBackgroundColor),
  ...
  static final darkTheme = ThemeData.dark().copyWith(
    ...
    appBarTheme:
        AppBarTheme(backgroundColor: MyAppColors.primaryBackgroundColorDark),
    inputDecorationTheme: InputDecorationTheme(
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(15.0),
        borderSide:
            BorderSide(color: MyAppColors.secondaryTextColorDark, width: 2.0),
      ),
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(15.0),
        borderSide:
            BorderSide(color: MyAppColors.primaryTextColorDark, width: 2.0),
      ),
    ),
